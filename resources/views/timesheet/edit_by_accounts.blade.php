    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select id="time-sheet" name="time_sheet"  class="form-control" required>
              <option value="{{$hour_in_number}}" selected>{{$hour_in_word}}</option>
        ...
        <div class="form-group hidden">
            <label>User id</label>
            <input type="text" class="form-control" name="user_id" id="user-id"  value="{{$time_sheet_data->user_id}}" readonly>   
          </div>
