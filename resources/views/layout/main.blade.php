      ...
      <ul class="sidebar-menu">
        ...
        <li {!! Request::is('*Settings*') ? ' class="active treeview"' : ' class="treeview"' !!}>
          ...
          <ul class="treeview-menu">
            ...
            <li {!! Request::is('*Settings') ? ' class="active"' : null !!} ><a href="{{URL::to('/') . '/permission/role'}}"><i class="fa fa-circle-o"></i>Roles</a></li>
            <li {!! Request::is('*Settings') ? ' class="active"' : null !!} ><a href="{{URL::to('/') . '/permission/permission'}}"><i class="fa fa-circle-o"></i>Permissions</a></li>
