...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_select__ = __webpack_require__(47);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('example', __webpack_require__(40));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('testing', __webpack_require__(42));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('practical-theme', __webpack_require__(41));



__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('v-select', __WEBPACK_IMPORTED_MODULE_1_vue_select___default.a);

var VueResource = __webpack_require__(46);
	...
	mounted: function mounted() {
		...
		var jqxhr = $.get("/contact_theme/get_all_themes", function (themes) {
			...
			for (var i = 0; i < object.length; i++) {
				...
				table.row.add([object[i].id, object[i].name, '<a type="button" class="btn bg-purple margin" data-toggle="modal" data-target="#test-modal">New Theme</a>']).draw(false);
			}
		});
	},
	data: function data() {
...
var update = __webpack_require__(10)("40804a62", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("3cc05bd6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
